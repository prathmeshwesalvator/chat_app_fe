...
mixin _$LoginState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loginStatus, username, password,
...
extension LoginStatePatterns on LoginState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Blocstatus? loginStatus, String username, String password,
    ...
    switch (_that) {
      case _LoginState() when $default != null:
        return $default(_that.loginStatus, _that.username, _that.password,
            _that.errorMessage, _that.successMessage);
      case _:
        return orElse();
    }
  }
