...
part of 'qr_analysis_service.dart';
...
class _QrAnalysisService implements QrAnalysisService {
  _QrAnalysisService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<QrModel> generateHash() async {
    ...
    final _options = _setStreamType<QrModel>(
    ...
    late QrModel _value;
    try {
      _value = QrModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<UserInfoModel> getInfo(Map<String, dynamic> body) async {
