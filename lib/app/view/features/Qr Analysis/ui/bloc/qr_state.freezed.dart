...
mixin _$QrState {
 ...
 QrEntities? get qrData; Blocstatus? get qrStatus; String get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QrState&&(identical(other.qrData, qrData) || other.qrData == qrData)&&(identical(other.qrStatus, qrStatus) || other.qrStatus == qrStatus)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
/// Create a copy of QrState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? qrData = freezed,Object? qrStatus = freezed,Object? errorMessage = null,}) {
  return _then(_self.copyWith(
qrData: freezed == qrData ? _self.qrData : qrData // ignore: cast_nullable_to_non_nullable
as QrEntities?,qrStatus: freezed == qrStatus ? _self.qrStatus : qrStatus // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( QrEntities? qrData,  Blocstatus? qrStatus,  String errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QrState() when $default != null:
return $default(_that.qrData,_that.qrStatus,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( QrEntities? qrData,  Blocstatus? qrStatus,  String errorMessage)  $default,) {final _that = this;
switch (_that) {
case _QrState():
return $default(_that.qrData,_that.qrStatus,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( QrEntities? qrData,  Blocstatus? qrStatus,  String errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _QrState() when $default != null:
return $default(_that.qrData,_that.qrStatus,_that.errorMessage);case _:
  return null;
...
@override final  QrEntities? qrData;
@override final  Blocstatus? qrStatus;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _QrState&&(identical(other.qrData, qrData) || other.qrData == qrData)&&(identical(other.qrStatus, qrStatus) || other.qrStatus == qrStatus)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
/// Create a copy of QrState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? qrData = freezed,Object? qrStatus = freezed,Object? errorMessage = null,}) {
