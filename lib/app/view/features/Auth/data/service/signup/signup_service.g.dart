...
class _SignUpService implements SignUpService {
  ...
  @override
  Future<Success> sendOtp(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{'requestType': 'TYPE_C'};
  ...
  @override
  Future<Success> verifyOtp(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{'requestType': 'TYPE_C'};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<SignupModel> signupSubmit(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{'requestType': 'TYPE_C'};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
