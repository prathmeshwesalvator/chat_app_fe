...
mixin _$CurrentUser {
 ...
 String get message;@IntToStringConverter() String? get userId; String get username; String get email; String get dateJoined;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,message,userId,username,email,dateJoined);
...
@useResult
$Res call({
 String message,@IntToStringConverter() String? userId, String username, String email, String dateJoined
});
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? userId = freezed,Object? username = null,Object? email = null,Object? dateJoined = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message, @IntToStringConverter()  String? userId,  String username,  String email,  String dateJoined)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.message,_that.userId,_that.username,_that.email,_that.dateJoined);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message, @IntToStringConverter()  String? userId,  String username,  String email,  String dateJoined)  $default,) {final _that = this;
switch (_that) {
case _CurrentUser():
return $default(_that.message,_that.userId,_that.username,_that.email,_that.dateJoined);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message, @IntToStringConverter()  String? userId,  String username,  String email,  String dateJoined)?  $default,) {final _that = this;
switch (_that) {
case _CurrentUser() when $default != null:
return $default(_that.message,_that.userId,_that.username,_that.email,_that.dateJoined);case _:
  return null;
...
class _CurrentUser implements CurrentUser {
  const _CurrentUser({this.message = '', @IntToStringConverter() this.userId, this.username = '', this.email = '', this.dateJoined = ''});
  factory _CurrentUser.fromJson(Map<String, dynamic> json) => _$CurrentUserFromJson(json);

@override@JsonKey() final  String message;
@override@IntToStringConverter() final  String? userId;
...
/// Create a copy of CurrentUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? userId = freezed,Object? username = null,Object? email = null,Object? dateJoined = null,}) {
